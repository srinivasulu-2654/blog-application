...
public class JwtTokenHelper {
    ...
    private String secret = "this_is_a_very_long_super_secure_jwt_secret_key_64_characters_long_123456";
...
//        return Jwts.parser().setSigningKey(secret).parseClaimsJws(token).getBody(); old method
